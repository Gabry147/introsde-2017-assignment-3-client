 ...
 * 
 */
@WebServiceClient(name = "PersonImplService", targetNamespace = "http://soap.assignment3.introsde/", wsdlLocation = "http://sde3-2017-scarton.herokuapp.com/person?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://sde3-2017-scarton.herokuapp.com/person?wsdl");
    ...
    public PersonService getPersonImplPort() {
        return super.getPort(new QName("http://soap.assignment3.introsde/", "PersonImplPort"), PersonService.class);
    }
     ...
     */
    @WebEndpoint(name = "PersonImplPort")
    public PersonService getPersonImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.assignment3.introsde/", "PersonImplPort"), PersonService.class, features);
    }
